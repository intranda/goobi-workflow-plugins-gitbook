...
Letzte Änderung    | 25.07.2024 11:56:44
...
![Der Erscheinungsort London ist in einer besonderen Schreibweise in den Metadaten vorhanden](images/goobi-plugin-step-metadata-replacement_screen5.png)
...
![In einem eigenen Vokabular für Ortsnamen können individuelle Daten für eine Anreicherung gepflegt werden](images/goobi-plugin-step-metadata-replacement_screen3.png)
...
![Der Erscheinungsort London ist nun in einem eigenen Feld mit korrekter Schreibweise und Normdaten vorhanden](images/goobi-plugin-step-metadata-replacement_screen4.png)
...
![Auswahl des Plugins innerhalb einer Aufgabe](images/goobi-plugin-step-metadata-replacement_screen1.png)

![Integration der Ersetzung von Metadaten innerhalb des Workflows](images/goobi-plugin-step-metadata-replacement_screen2.png)